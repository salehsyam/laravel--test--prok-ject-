    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">{{__('messages.employee')}}</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body ">
                <table class="table table-bordered  table-striped table-hover ">
                    ...
                    @foreach($employees as $employee)
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="{{route('admin.employees.edit',$employee->id)}}" class="btn btn-success btn-flat">
                                        <i class="fas  fa-edit "></i>
                                    </a>

                                        <a href="#" onclick="confirmDelete('{{$employee->id}}',this)" class="btn btn-danger btn-flat">
